...
function format(decimal, precision = 2) {
	...
	} if (decimal.gte("1e1000")) return exponentialFormat(decimal, 0);
...
function fixData(defaultData, newData) {
	for (item in defaultData) {
		...
		} else if ((Boolean(defaultData[item])) && (defaultData[item].constructor === Object)) {
